...
_C.SERVER.gpus = 1
# train on SICE
_C.SERVER.TRAIN_DATA = '/nvme0/shared_data/MambaMEF/dataset/SICE_train'
_C.SERVER.VAL_DATA = '/nvme0/shared_data/MambaMEF/dataset/SICE_train'
_C.SERVER.TEST_DATA = '/nvme0/shared_data/MambaMEF/dataset/MEFB'
_C.SERVER.OUTPUT = '/nvme0/shared_data/MambaMEF/output/job1/log'
